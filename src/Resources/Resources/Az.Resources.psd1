...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* [Breaking Change] Redesigned CRUD cmdlets for ''PolicyAssignment'', ''PolicyDefinition'', ''PolicyExemption'', ''PolicySetDefinition''. Please see Az 12 migration guide https://learn.microsoft.com/en-us/powershell/azure/migrate-az-12.0.0 for more detail.
