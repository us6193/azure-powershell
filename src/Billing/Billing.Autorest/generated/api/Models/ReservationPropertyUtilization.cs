...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class ReservationPropertyUtilization :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationPropertyUtilization,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationPropertyUtilizationInternal
    {

        /// <summary>Backing field for <see cref="Aggregate" /> property.</summary>
        private System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationUtilizationAggregates> _aggregate;
        ...
        public System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationUtilizationAggregates> Aggregate { get => this._aggregate; set => this._aggregate = value; }

        /// <summary>Internal Acessors for Trend</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationPropertyUtilizationInternal.Trend { get => this._trend; set { {_trend = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.IJsonSerializable
    {
        ...
        System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationUtilizationAggregates> Aggregate { get; set; }
        /// <summary>last 7 day utilization trend for a reservation</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Info(
        Required = false,
        ReadOnly = true,
