...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class TransactionProperties
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.ITransactionProperties.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.ITransactionProperties.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.ITransactionProperties FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._consumptionCommitmentDecremented ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._consumptionCommitmentDecremented.ToJson(null,serializationMode) : null, "consumptionCommitmentDecremented" ,container.Add );
            ...
            AddIf( null != this._refundTransactionDetail ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) this._refundTransactionDetail.ToJson(null,serializationMode) : null, "refundTransactionDetails" ,container.Add );
            ...
            AddIf( null != (((object)this._creditType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._creditType.ToString()) : null, "creditType" ,container.Add );
            ...
            AddIf( null != this._isThirdParty ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonBoolean((bool)this._isThirdParty) : null, "isThirdParty" ,container.Add );
            ...
            AddIf( null != (((object)this._partNumber)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString(this._partNumber.ToString()) : null, "partNumber" ,container.Add );
        ...
        internal TransactionProperties(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_azureCreditApplied = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("azureCreditApplied"), out var __jsonAzureCreditApplied) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesAzureCreditApplied.FromJson(__jsonAzureCreditApplied) : _azureCreditApplied;}
            {_consumptionCommitmentDecremented = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("consumptionCommitmentDecremented"), out var __jsonConsumptionCommitmentDecremented) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesConsumptionCommitmentDecremented.FromJson(__jsonConsumptionCommitmentDecremented) : _consumptionCommitmentDecremented;}
            {_effectivePrice = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("effectivePrice"), out var __jsonEffectivePrice) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesEffectivePrice.FromJson(__jsonEffectivePrice) : _effectivePrice;}
            {_marketPrice = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("marketPrice"), out var __jsonMarketPrice) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesMarketPrice.FromJson(__jsonMarketPrice) : _marketPrice;}
            {_subTotal = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("subTotal"), out var __jsonSubTotal) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesSubTotal.FromJson(__jsonSubTotal) : _subTotal;}
            {_tax = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("tax"), out var __jsonTax) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesTax.FromJson(__jsonTax) : _tax;}
            {_transactionAmount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("transactionAmount"), out var __jsonTransactionAmount) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesTransactionAmount.FromJson(__jsonTransactionAmount) : _transactionAmount;}
            {_refundTransactionDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("refundTransactionDetails"), out var __jsonRefundTransactionDetails) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.TransactionPropertiesRefundTransactionDetails.FromJson(__jsonRefundTransactionDetails) : _refundTransactionDetail;}
            {_azurePlan = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("azurePlan"), out var __jsonAzurePlan) ? (string)__jsonAzurePlan : (string)_azurePlan;}
            ...
            {_creditType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("creditType"), out var __jsonCreditType) ? (string)__jsonCreditType : (string)_creditType;}
            ...
            {_discount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("discount"), out var __jsonDiscount) ? (float?)__jsonDiscount : _discount;}
            {_exchangeRate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("exchangeRate"), out var __jsonExchangeRate) ? (float?)__jsonExchangeRate : _exchangeRate;}
            {_invoice = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("invoice"), out var __jsonInvoice) ? (string)__jsonInvoice : (string)_invoice;}
            ...
            {_isThirdParty = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonBoolean>("isThirdParty"), out var __jsonIsThirdParty) ? (bool?)__jsonIsThirdParty : _isThirdParty;}
            {_kind = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("kind"), out var __jsonKind) ? (string)__jsonKind : (string)_kind;}
            {_partNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("partNumber"), out var __jsonPartNumber) ? (string)__jsonPartNumber : (string)_partNumber;}
            {_pricingCurrency = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("pricingCurrency"), out var __jsonPricingCurrency) ? (string)__jsonPricingCurrency : (string)_pricingCurrency;}
            {_productDescription = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("productDescription"), out var __jsonProductDescription) ? (string)__jsonProductDescription : (string)_productDescription;}
            {_productFamily = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("productFamily"), out var __jsonProductFamily) ? (string)__jsonProductFamily : (string)_productFamily;}
            ...
            {_quantity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("quantity"), out var __jsonQuantity) ? (int?)__jsonQuantity : _quantity;}
            ...
            {_servicePeriodStartDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("servicePeriodStartDate"), out var __jsonServicePeriodStartDate) ? global::System.DateTime.TryParse((string)__jsonServicePeriodStartDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonServicePeriodStartDateValue) ? __jsonServicePeriodStartDateValue : _servicePeriodStartDate : _servicePeriodStartDate;}
            {_servicePeriodEndDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("servicePeriodEndDate"), out var __jsonServicePeriodEndDate) ? global::System.DateTime.TryParse((string)__jsonServicePeriodEndDate, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonServicePeriodEndDateValue) ? __jsonServicePeriodEndDateValue : _servicePeriodEndDate : _servicePeriodEndDate;}
            {_transactionType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("transactionType"), out var __jsonTransactionType) ? (string)__jsonTransactionType : (string)_transactionType;}
            {_unit = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNumber>("units"), out var __jsonUnits) ? (float?)__jsonUnits : _unit;}
            {_unitOfMeasure = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("unitOfMeasure"), out var __jsonUnitOfMeasure) ? (string)__jsonUnitOfMeasure : (string)_unitOfMeasure;}
            {_unitType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("unitType"), out var __jsonUnitType) ? (string)__jsonUnitType : (string)_unitType;}
