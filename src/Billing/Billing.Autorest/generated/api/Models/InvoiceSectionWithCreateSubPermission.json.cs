...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class InvoiceSectionWithCreateSubPermission
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoiceSectionWithCreateSubPermission.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoiceSectionWithCreateSubPermission.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IInvoiceSectionWithCreateSubPermission FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal InvoiceSectionWithCreateSubPermission(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_billingProfileSystemId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("billingProfileSystemId"), out var __jsonBillingProfileSystemId) ? (string)__jsonBillingProfileSystemId : (string)_billingProfileSystemId;}
            ...
            {_invoiceSectionSystemId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonString>("invoiceSectionSystemId"), out var __jsonInvoiceSectionSystemId) ? (string)__jsonInvoiceSectionSystemId : (string)_invoiceSectionSystemId;}
            AfterFromJson(json);
        }
