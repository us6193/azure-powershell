...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class AvailableBalancePropertiesTotalPaymentsOnAccount
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject into a new instance of <see cref="AvailableBalancePropertiesTotalPaymentsOnAccount"
        /// />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AvailableBalancePropertiesTotalPaymentsOnAccount(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            __amount = new Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.Amount(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IAvailableBalancePropertiesTotalPaymentsOnAccount.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IAvailableBalancePropertiesTotalPaymentsOnAccount.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IAvailableBalancePropertiesTotalPaymentsOnAccount FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json ? new AvailableBalancePropertiesTotalPaymentsOnAccount(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AvailableBalancePropertiesTotalPaymentsOnAccount" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AvailableBalancePropertiesTotalPaymentsOnAccount" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
