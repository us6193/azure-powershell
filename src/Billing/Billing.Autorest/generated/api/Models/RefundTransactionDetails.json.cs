...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class RefundTransactionDetails
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IRefundTransactionDetails.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IRefundTransactionDetails.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IRefundTransactionDetails FromJson(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonNode node)
        {
        ...
        internal RefundTransactionDetails(Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject json)
        {
            ...
            {_amountRequested = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("amountRequested"), out var __jsonAmountRequested) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.RefundTransactionDetailsAmountRequested.FromJson(__jsonAmountRequested) : _amountRequested;}
            {_amountRefunded = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Billing.Runtime.Json.JsonObject>("amountRefunded"), out var __jsonAmountRefunded) ? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.RefundTransactionDetailsAmountRefunded.FromJson(__jsonAmountRefunded) : _amountRefunded;}
