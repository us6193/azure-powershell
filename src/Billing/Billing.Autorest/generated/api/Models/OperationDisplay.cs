...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class OperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
