...
namespace Microsoft.Azure.PowerShell.Cmdlets.Billing.Models
{
    ...
    public partial class ReservationSummary :
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummary,
        Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal
    {
        ...
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.CancelledCount { get => this._cancelledCount; set { {_cancelledCount = value;} } }

        /// <summary>Internal Acessors for ExpiredCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.ExpiredCount { get => this._expiredCount; set { {_expiredCount = value;} } }

        /// <summary>Internal Acessors for ExpiringCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.ExpiringCount { get => this._expiringCount; set { {_expiringCount = value;} } }

        /// <summary>Internal Acessors for FailedCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.FailedCount { get => this._failedCount; set { {_failedCount = value;} } }

        /// <summary>Internal Acessors for NoBenefitCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.NoBenefitCount { get => this._noBenefitCount; set { {_noBenefitCount = value;} } }

        /// <summary>Internal Acessors for PendingCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.PendingCount { get => this._pendingCount; set { {_pendingCount = value;} } }

        /// <summary>Internal Acessors for ProcessingCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.ProcessingCount { get => this._processingCount; set { {_processingCount = value;} } }

        /// <summary>Internal Acessors for SucceededCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.SucceededCount { get => this._succeededCount; set { {_succeededCount = value;} } }

        /// <summary>Internal Acessors for WarningCount</summary>
        float? Microsoft.Azure.PowerShell.Cmdlets.Billing.Models.IReservationSummaryInternal.WarningCount { get => this._warningCount; set { {_warningCount = value;} } }
